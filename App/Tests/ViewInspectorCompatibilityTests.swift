...
struct ViewInspectorCompatibilityTests {
    ...
    func geometryReaderTraversalWorks() throws {
        ...
        // In this project PreviewDiffView.swift, ImpactView.swift,
        // PreviewChangesView.swift, LiveDiffLinesView.swift and
        // ConfigDiffPanel.swift render a GeometryReader, so their tests depend
        // on this working.
