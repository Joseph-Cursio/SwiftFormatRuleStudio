...
struct ViewInspectorCompatibilityTests {
    ...
    func geometryProxyLayoutIsSupported() {
        ...
        #expect(
            ...
            kills the test process. In this project that is ImpactView.swift, PreviewChangesView.swift, LiveDiffLinesView.swift, ConfigDiffPanel.swift and PreviewDiffView.swift. Any suite \
